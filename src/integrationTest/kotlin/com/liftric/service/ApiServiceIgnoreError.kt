...
import com.liftric.model.ProjectData
...
/**
 * This ApiServiceIgnoreError class is a workaround for a specific issue when running Dependency Track with Docker Compose
 ...
 *
 * To circumvent this, ApiServiceIgnoreError is used to handle project creation requests, with `expectSuccess` set to false
 * by default. It is essentially a duplicate of the standard ApiService, with the sole difference being its error handling behavior.
 *
 * This setup allows us to run integration tests seamlessly, even with the aforementioned Docker configuration.
 */

class ApiServiceIgnoreError(
